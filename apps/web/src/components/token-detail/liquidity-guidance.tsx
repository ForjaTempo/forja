		...
		<Card className="border-anvil-gray-light bg-deep-charcoal">
			<CardHeader className="pb-3">
				<CardTitle className="flex items-center gap-2 text-base">
					<InfoIcon className="size-4 text-molten-amber" />
					Add Liquidity
				</CardTitle>
			</CardHeader>
			<CardContent className="space-y-4">
				<div className="rounded-lg border border-molten-amber/20 bg-molten-amber/5 p-3">
				...
				<div className="space-y-2">
					<h4 className="text-sm font-medium text-smoke">General Steps</h4>
					<ol className="space-y-1.5 text-xs text-smoke-dark">
						<li className="flex gap-2">
							<span className="shrink-0 text-molten-amber">1.</span>
							<span>Connect your wallet to the Uniswap interface on Tempo</span>
						</li>
						<li className="flex gap-2">
							<span className="shrink-0 text-molten-amber">2.</span>
							<span>Create a new pool with your token and a base token (e.g., USDC)</span>
						</li>
						<li className="flex gap-2">
							<span className="shrink-0 text-molten-amber">3.</span>
							<span>Set initial price and add liquidity</span>
						</li>
						<li className="flex gap-2">
							<span className="shrink-0 text-molten-amber">4.</span>
				...
				<div className="space-y-2">
					<h4 className="text-sm font-medium text-smoke">Tempo Uniswap Contracts</h4>
					<div className="space-y-1">
						{UNISWAP_CONTRACTS.map((contract) => (
							<div key={contract.name} className="flex items-center justify-between text-xs">
								<span className="text-smoke-dark">{contract.name}</span>
				...
				<a
					...
					className="inline-flex items-center gap-1 text-xs text-molten-amber transition-colors hover:text-molten-amber/80"
				>
